 ...
 */
public class TemplateOptionsFragment extends Fragment {


    private final String LOG_TAG = TemplateOptionsFragment.class.getSimpleName();
    ...
    public TemplateOptionsFragment() {
    }
